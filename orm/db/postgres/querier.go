...
type Querier interface {
	...
	CreateDriverService(ctx context.Context, arg CreateDriverServiceParams) (DriverService, error)
	...
	GetDriverServicesByDriverID(ctx context.Context, driverID uuid.UUID) ([]DriverService, error)
