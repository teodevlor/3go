...
BEGIN
    ...
    AND EXISTS (
        ...
        IF v_admin_id IS NOT NULL THEN
            -- Tạo role supper-admin nếu chưa có
            ...
            -- Gán role supper-admin cho supperadmin@gogogo.com nếu chưa gán
            IF NOT EXISTS (
                SELECT 1
            ...
            -- Gán toàn bộ permissions cho role supper-admin (full quyền)
