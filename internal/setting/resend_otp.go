...
// ResendOTPConfig là cấu hình resend OTP từ bảng settings (key: config_resent_otp).
// Không phải request/response API — dùng cho logic nghiệp vụ, parse từ JSON trong settings.
// Khớp với JSON trong seed 20260205100000_init_setting_resend_otp.sql.
